...
if (nav) {
  var html = `
    <div class="fixed-nav-bar-container">
      <a class="icon" href="/./">tiyoneinnnetowork</a>
    </div>
    <div class="fixed-nav-bar-right">
      <a class="navbar-link" href="/./g.pdf"><i class="fa-solid fa-gamepad navbar-icon"></i><xn>Ga</xn><xn>mes</xn></a>
      <a class="navbar-link" href="/./ap.pdf"><i class="fa-solid fa-phone navbar-icon"></i><xn>Ap</xn><xn>ps</xn></a>
      <a class="navbar-link" href="/./t.pdf"><i class="fa-solid fa-laptop navbar-icon"></i><xn>Ta</xn><xn>bs</xn></a>
      <a class="navbar-link" href="/./s.pdf"><i class="fa-solid fa-gear navbar-icon settings-icon"></i><xn>Set</xn><xn>tings</xn></a>
      <a class="navbar-link" href="/./emu.pdf"><i class="fa-solid fa-laptop navbar-icon"></i><xn>Emu</xn><xn>lator</xn></a>
    </div>`
  nav.innerHTML = html
}
